...
class ScheduleUseCase {
    ...
    async importSchedules(userId, schedules) {
        ...
        const safeSchedules = schedules.map((schedule) => {
            ...
            return {
                ...
                title: (0, validation_1.cleanText)(schedule.title, '일정 제목', 80),
                color: schedule.color ? (0, validation_1.validateHexColor)(schedule.color) : '#06b6d4',
            };
        });
